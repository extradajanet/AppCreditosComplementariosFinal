...
android {
    namespace = "com.example.creditoscomplementariosfinal"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.creditoscomplementariosfinal"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Gson (if you're using it directly, though converter-gson often pulls it in)
    implementation ("com.google.code.gson:gson:2.10.1") // Use the latest stable version

    // Kotlin Coroutines for Retrofit (if you're using suspend functions)
